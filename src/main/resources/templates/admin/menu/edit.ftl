                                ...
                                <form action="add" id="menu-add-form" method="post" class="row">
                                        ...
                                        <select name="parent.id" class="form-control" id="type">
                                            ...
                                            <#if topMenus??>
                                                <#list topMenus as topMenu>
                                                    <option value="${topMenu.id}" style="font-weight:bold;"
                                                            <#if menu.parent??><#if topMenu.id == menu.parent.id>selected</#if></#if>>${topMenu.name}</option>
                                                    <#if secondMenus??>
                                                        <#list secondMenus as secondMenu>
                                                            <#if secondMenu.parent.id == topMenu.id>
                                                                <option value="${secondMenu.id}"
                                                                        <#if menu.parent??><#if secondMenu.id == menu.parent.id>selected</#if></#if>>
                                                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${secondMenu.name}</option>
                                                            </#if>
                                                        </#list>
                                                    </#if>
                                                </#list>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="name" name="name"
                                               value="${menu.name}" placeholder="请输入菜单名称" tips="请填写菜单名称"/>
                                    </div>
                                    <div class="input-group m-b-10">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" readonly="readonly" class="form-control required" id="icon"
                                               name="icon" value="${menu.icon}" placeholder="请输入菜单icon"
                                               tips="请选择菜单icon"/>
                                        <span class="input-group-btn">
                      <button class="btn btn-primary" id="show-icons-btn" data-toggle="modal" data-target="#icons-panel"
                              type="button">点击选择</button>
                    </span>
                                    </div>
                                    <div class="input-group m-b-10">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="button" value="true"
                                                   <#if menu.button == true>checked</#if> >
                                            <span>是</span>
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input type="radio" name="button" value="false"
                                                       <#if menu.button == false>checked</#if>>
                                                <span>否</span>
                                            </label>
                                    </div>
                                    <div class="input-group m-b-10">
                                        ...
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="show" value="true"
                                                   <#if menu.show == true>checked</#if> >
                                            <span>是</span>
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input type="radio" name="show" value="false"
                                                       <#if menu.show == false>checked</#if>>
                                                <span>否</span>
                                            </label>
                                    </div>
