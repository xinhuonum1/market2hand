                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)" data-field="title">名称</a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as goodsCategory>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]"
                                                                   value="${goodsCategory.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle;">
                                                        <#if goodsCategory.icon??>
                                                            <#if goodsCategory.icon?length gt 0>
                                                                <img src="/photo/view?filename=${goodsCategory.icon}"
                                                                     width="30px" height="30px">
                                                            <#else>
                                                                <img src="/admin/images/default-category-icon.png"
                                                                     width="30px" height="30px">
                                                            </#if>
                                                        </#if>
                                                    </td>
                                                    ...
                                                    <td style="vertical-align:middle;"
                                                        align="center">${goodsCategory.sort}</td>
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;">
                                                        <font class="text-success">${goodsCategory.createTime}</font>
                                                    </td>
                                                </tr>
                                            </#list>
                                        <#else>
