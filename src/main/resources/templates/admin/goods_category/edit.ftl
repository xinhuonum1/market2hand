                                ...
                                <form action="add" id="category-add-form" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" readonly="readonly" class="form-control required" id="icon"
                                               name="icon" value="${goodsCategory.icon}" placeholder="请上传分类icon"
                                               tips="请上传分类icon"/>
                      ...
                      <button class="btn btn-primary" id="add-pic-btn" type="button">点击上传</button>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="name" name="name"
                                               value="${goodsCategory.name}" placeholder="请输入分类名称" tips="请填写用分类名称"/>
                                    </div>
                                    <div class="input-group m-b-10">
                                        ...
                                        <select name="parent.id" class="form-control" id="category">
                                            <#if goodsCategorys??>
                                                ...
                                                <#list goodsCategorys as gc>
                                                    <option value="${gc.id}"
                                                            <#if goodsCategory.parent??><#if gc.id == goodsCategory.parent.id>selected</#if></#if>>${gc.name}</option>
                                                </#list>
                                            </#if>
                                        </select>
                                    </div>
