                            ...
                            <div class="card-body">
                                            ...
                                            <#list pageBean.content as operaterLog>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]"
                                                                   value="${operaterLog.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    ...
                                                    <td style="vertical-align:middle;"><font
                                                                class="text-success">${operaterLog.createTime}</font>
                                                    </td>
                                                </tr>
                                            </#list>
                                        <#else>
                                            <tr align="center">
                                                <td colspan="4">这里空空如也！</td>
                                            </tr>
                                        </#if>
                                        </tbody>
                                    </table>
                                ...
                                <#if pageBean.total gt 0>
                                    <ul class="pagination">
                                        ...
                                        <#else>
                                            <li><a href="operator_log_list?operator=${operator!""}&currentPage=1">«</a>
                                            </li>
                                        </#if>
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="operator_log_list?operator=${operator!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                        ...
                                        <#else>
                                            <li>
                                                <a href="operator_log_list?operator=${operator!""}&currentPage=${pageBean.totalPage}">»</a>
                                            </li>
                                        </#if>
