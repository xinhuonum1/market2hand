                                ...
                                <div class="edit-avatar">
                                    <#if ylrc_user.headPic??>
                                        <#if ylrc_user.headPic?length gt 0>
                                            <img src="/photo/view?filename=${ylrc_user.headPic}" id="show-img"
                                                 class="img-avatar">
                                        <#else>
                                    ...
                                    <input type="file" id="select-file" style="display:none;"
                                           onchange="upload('show-img','headPic')">
                                ...
                                <form method="post" action="update_userinfo" class="site-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="username" id="username"
                                               value="${ylrc_user.username}" disabled="disabled"/>
                                    </div>
                                    <div class="form-group">
                                        <label for="nickname">手机</label>
                                        <input type="text" class="form-control" name="mobile" id="mobile"
                                               placeholder="输入您的手机号码" value="${ylrc_user.mobile!""}">
                                    </div>
                                    <div class="form-group">
                                        <label for="email">邮箱</label>
                                        <input type="email" class="form-control" name="email" id="email"
                                               aria-describedby="emailHelp" placeholder="请输入正确的邮箱地址"
                                               value="${ylrc_user.email!""}">
                                    </div>
