                                ...
                                <form action="add" id="role-add-form" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="name" name="name"
                                               value="${role.name!""}" placeholder="请输入角色名称" tips="请填写角色名称"/>
                                    </div>
                                            ...
                                            <#if topMenus??>
                                                <#list topMenus as topMenu>
                                                    <tr>
                                                        <td>
                                                            <label class="lyear-checkbox checkbox-primary">
                                                                <input name="authorities" type="checkbox"
                                                                       class="checkbox-parent" dataid="id-${topMenu.id}"
                                                                       value="${topMenu.id}">
                                                                    ...
                                                                    <td class="p-l-20">
                                                                        <label class="lyear-checkbox checkbox-primary">
                                                                            <input name="authorities" type="checkbox"
                                                                                   ...
                                                                                   dataid="id-${topMenu.id}-${secondMenu.id}"
                                                                                   value="${secondMenu.id}">
                                                                                ...
                                                                                <#if thirdMenu.parent.id == secondMenu.id>
                                                                                    <label class="lyear-checkbox checkbox-primary checkbox-inline">
                                                                                        <input name="authorities"
                                                                                               ...
                                                                                               dataid="id-${topMenu.id}-${secondMenu.id}-${thirdMenu.id}"
                                                                                               value="${thirdMenu.id}">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <label class="lyear-radio radio-inline radio-primary">
                                            <input type="radio" name="status" value="1"
                                                   <#if role.status == 1>checked</#if>>
                                            <span>启用</span>
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input type="radio" name="status" value="0"
                                                       <#if role.status == 0>checked</#if>>
                                                <span>不启用</span>
                                            </label>
                                    </div>
                                    <div class="input-group m-b-10">
