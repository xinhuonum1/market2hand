...
<head>
    ...
    <title>${siteName!""}|友情链接管理-${title!""}</title>
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as friendLink>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align:middle;"
                                                        align="center">${friendLink.sort}</td>
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;">
                                                        <font class="text-success">${friendLink.createTime}</font></td>
                                                </tr>
                                            </#list>
                                        <#else>
                                            <tr align="center">
                                                <td colspan="5">这里空空如也！</td>
                                            </tr>
                                        </#if>
                                        </tbody>
                                    </table>
    ...
    function deleteReq(ids, url) {
        $.ajax({
            ...
            success: function (data) {
                if (data.code == 0) {
                    showSuccessMsg('友情链接删除成功!', function () {
