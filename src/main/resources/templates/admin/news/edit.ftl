                                ...
                                <form action="add" id="user-add-form" method="post" class="row">
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="title" name="title"
                                               value="${news.title}" placeholder="请输入新闻公告标题" tips="请填写新闻公告标题"/>
                                    </div>
                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">内容</span>
                                        <textarea class="form-control required" id="content" name="content" rows="6"
                                                  placeholder="请输入新闻公告内容" tips="请填写新闻公告内容">${news.content}</textarea>
                                    </div>
                                    <div class="input-group m-b-10">
