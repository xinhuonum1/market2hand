                                        ...
                                        <div class="input-group-btn">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)"
                                                       data-field="title">新闻公告</a></li>
                                            </ul>
                                        </div>
                                        <input type="text" class="form-control" value="${newsTitle!""}" name="title"
                                               placeholder="请输入标题">
                                        ...
                                        <#if pageBean.content?size gt 0>
                                            <#list pageBean.content as news>
                                                <tr>
                                                    ...
                                                    <td style="vertical-align:middle;"
                                                        align="center">${news.viewNumber}</td>
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;">
                                                        <font class="text-success">${news.createTime}</font></td>
                                                </tr>
                                            </#list>
                                        <#else>
                                            <tr align="center">
                                ...
                                <#if pageBean.total gt 0>
                                    <ul class="pagination ">
                                        ...
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="list?title=${newsTitle!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                        ...
                                        <#else>
                                            <li>
                                                <a href="list?title=${newsTitle!""}&currentPage=${pageBean.totalPage}">»</a>
                                            </li>
                                        </#if>
