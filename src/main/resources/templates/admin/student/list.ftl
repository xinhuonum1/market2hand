                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)" data-field="title">学号</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <input type="text" class="form-control" value="${stuemail!""}" name="stuemail"
                                               placeholder="请输入邮箱号码">
                                            ...
                                            <#list pageBean.content as student>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]"
                                                                   value="${student.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle;">
                                                        <#if student.headPic??>
                                                            <img src="/photo/view?filename=${student.headPic}"
                                                                 width="60px" height="60px">
                                                        <#else>
                                                            <img src="/home/imgs/avatar1.png" width="60px"
                                                                 height="60px">
                                                        </#if>
                                                    </td>
                                                    ...
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;">
                                                        <font class="text-success">${student.createTime}</font></td>
                                                </tr>
                                            </#list>
                                        <#else>
                                            <tr align="center">
                                ...
                                <#if pageBean.total gt 0>
                                    <ul class="pagination ">
                                        ...
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="list?stuemail=${stuemail!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                        ...
                                        <#else>
                                            <li>
                                                <a href="list?stuemail=${stuemail!""}&currentPage=${pageBean.totalPage}">»</a>
                                            </li>
                                        </#if>
