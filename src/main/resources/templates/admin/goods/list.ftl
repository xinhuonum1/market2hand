                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            <button class="btn btn-default dropdown-toggle" id="search-btn"
                                                    ...
                                                    aria-expanded="false">
                                                <#if goodsCategoryName??>分类名称<#elseif stuemail??>用户邮箱<#elseif name??>物品名称<#else>搜索条件</#if>
                                                <span class="caret"></span>
                                            </button>
                                            <ul class="dropdown-menu">
                                                <li><a tabindex="-1" href="javascript:void(0)"
                                                       data-field="name">物品名称</a></li>
                                                <li><a tabindex="-1" href="javascript:void(0)"
                                                       data-field="student.stuemail">用户邮箱</a></li>
                                                <li><a tabindex="-1" href="javascript:void(0)"
                                                       data-field="goodsCategory.name">分类名称</a></li>
                                            </ul>
                                        </div>
                                        <input type="text" class="form-control"
                                               value="${name!stuemail!goodsCategoryName!""}" id="search-value"
                                               name="<#if goodsCategoryName??>goodsCategory.name<#elseif stuemail??>student.stuemail<#else>name</#if>"
                                               placeholder="请输入搜索值">
                            ...
                            <div class="card-body">
                                            ...
                                            <#list pageBean.content as goods>
                                                <tr>
                                                    <td style="vertical-align:middle;">
                                                        <label class="lyear-checkbox checkbox-primary">
                                                            <input type="checkbox" name="ids[]"
                                                                   value="${goods.id}"><span></span>
                                                        </label>
                                                    </td>
                                                    <td style="vertical-align:middle;">
                                                        <a href="/home/goods/detail?id=${goods.id}" target="_blank">
                                                            <img src="/photo/view?filename=${goods.photo}" width="30px"
                                                                 height="30px">
                                                        </a>
                                                    </td>
                                                    <td style="vertical-align:middle;">
                                                        <a href="/home/goods/detail?id=${goods.id}"
                                                           target="_blank">${goods.name}</a>
                                                    </td>
                                                    <td style="vertical-align:middle;">
                                                        ${goods.student.stuemail}
                                                    </td>
                                                    <td style="vertical-align:middle;">
                                                    ...
                                                    <td style="vertical-align:middle;" style="vertical-align:middle;">
                                                        <font class="text-success">${goods.createTime}</font></td>
                                                </tr>
                                            </#list>
                                        <#else>
                                            <tr align="center">
                                ...
                                <#if pageBean.total gt 0>
                                    <ul class="pagination ">
                                        ...
                                        <#else>
                                            <li>
                                                <a href="list?<#if goodsCategoryName??>goodsCategory.name<#elseif stuemail??>student.stuemail<#else>name</#if>=${name!stuemail!goodsCategoryName!""}&currentPage=1">«</a>
                                            </li>
                                        </#if>
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="list?<#if goodsCategoryName??>goodsCategory.name<#elseif stuemail??>student.stuemail<#else>name</#if>=${name!stuemail!goodsCategoryName!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                        ...
                                        <#else>
                                            <li>
                                                <a href="list?<#if goodsCategoryName??>goodsCategory.name<#elseif stuemail??>student.stuemail<#else>name</#if>=${name!stuemail!goodsCategoryName!""}&currentPage=${pageBean.totalPage}">»</a>
                                            </li>
                                        </#if>
