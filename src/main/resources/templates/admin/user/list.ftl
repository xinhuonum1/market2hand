                                                ...
                                                <tr>
                                                    ...
                                                    <td style="vertical-align:middle;">
                                                        <#if user.headPic??>
                                                            ...
                                                            <#else>
                                                                <img src="/admin/images/default-head.jpg" width="60px"
                                                                     height="60px">
                                                            </#if>
                                                        </#if>
                                                    </td>
                                ...
                                <#if pageBean.total gt 0>
                                    <ul class="pagination ">
                                        ...
                                        <#list pageBean.currentShowPage as showPage>
                                            ...
                                            <#else>
                                                <li>
                                                    <a href="list?username=${username!""}&currentPage=${showPage}">${showPage}</a>
                                                </li>
                                            </#if>
                                        </#list>
                                        ...
                                        <#else>
                                            <li>
                                                <a href="list?username=${username!""}&currentPage=${pageBean.totalPage}">»</a>
                                            </li>
                                        </#if>
