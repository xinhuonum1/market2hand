                                ...
                                <form action="add" id="user-add-form" method="post" class="row">
                                                ...
                                                <li class="col-xs-4 col-sm-3 col-md-2">
                                                    <figure>
                                                        <#if user.headPic?length gt 0>
                                                            <img src="/photo/view?filename=${user.headPic}"
                                                                 id="show-picture-img">
                                                        <#else>
                                                            <img src="/admin/images/default-head.jpg"
                                                                 id="show-picture-img" alt="默认头像">
                                                        </#if>
                                                    </figure>
                                                </li>
                                    ...
                                    <div class="input-group m-b-10">
                                        ...
                                        <input type="text" class="form-control required" id="username" name="username"
                                               value="${user.username}" placeholder="请输入用户名" tips="请填写用户名"/>
                                    </div>
                                    <div class="input-group m-b-10">
                                        <span class="input-group-addon">登录密码</span>
                                        <input type="password" class="form-control required" id="password"
                                               name="password" value="${user.password}" placeholder="请输入登录密码"
                                               tips="请填写登录密码"/>
                                    </div>
                                    <div class="input-group m-b-10">
                                        ...
                                        <select name="role.id" class="form-control" id="role">
                                            <#list roles as role>
                                                <option value="${role.id}"
                                                        <#if user.role.id == role.id>selected</#if> >${role.name}</option>
                                            </#list>
                                        </select>
                                    </div>
                                    <div class="input-group m-b-10">
                                    ...
                                    <div class="input-group"
                                        ...
                                        <label class="lyear-radio radio-inline radio-primary" style="margin-left:30px;">
                                            <input type="radio" name="sex"
                                                   value="1" <#if user.sex == 1> checked </#if> >
                                            <span>男</span>
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input type="radio" name="sex"
                                                       value="2" <#if user.sex == 2> checked </#if>>
                                                <span>女</span>
                                                <label class="lyear-radio radio-inline radio-primary">
                                                    <input type="radio" name="sex"
                                                           value="0" <#if user.sex == 0> checked </#if>>
                                                    <span>未知</span>
                                                </label>
                                    </div>
                                    <div class="input-group"
                                        ...
                                        <label class="lyear-radio radio-inline radio-primary" style="margin-left:30px;">
                                            <input type="radio" name="status"
                                                   value="1" <#if user.status == 1> checked </#if>>
                                            <span>正常</span>
                                            <label class="lyear-radio radio-inline radio-primary">
                                                <input type="radio" name="status"
                                                       value="0" <#if user.status == 0> checked </#if>>
                                                <span>冻结</span>
                                            </label>
                                    </div>
                                    <div class="form-group col-md-12">
