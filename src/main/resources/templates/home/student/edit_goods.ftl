            ...
            <div class="form-wr">
                <div class="form-must-wr">
                    ...
                    <div class="form-item l goods-title">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input id="name" name="name" placeholder="最多18个字" maxlength="18" value="${goods.name}"
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <textarea name="content" id="desc" placeholder="建议填写物品用途、新旧程度、原价等信息，至少15个字"
                                          class="required" tips="请填写详情描述">${goods.content}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-item l goods-price">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="buyPrice" name="buyPrice" value="${goods.buyPrice}"
                    ...
                    <div class="form-item l goods-price">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="sellPrice" name="sellPrice" value="${goods.sellPrice}"
