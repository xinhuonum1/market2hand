            ...
            <div class="form-wr">
                <div class="form-must-wr">
                    <div class="form-item l goods-title">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input id="name" name="name" placeholder="最多18个字" maxlength="18"
                                       value="${wantedGoods.name}" type="text" class="required" tips="请填写商品名称"></div>
                        </div>
                    </div>
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <textarea name="content" id="desc" placeholder="建议填写物品用途、新旧程度、原价等信息，至少15个字"
                                          class="required" tips="请填写详情描述">${wantedGoods.content}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-item l goods-title">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="required" id="tradePlace" name="tradePlace"
                                       value="${wantedGoods.tradePlace}" type="text" tips="请填写期望交易地点"></div>
                        </div>
                    </div>
                    <div class="form-item l goods-price">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="sellPrice" name="sellPrice"
                                       value="${wantedGoods.sellPrice}" type="number" tips="请填写期望价格"></div>
                        </div>
                    </div>
                    <div class="form-item l">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="required" id="needNumber" name="needNumber"
                                       value="${wantedGoods.needNumber}" type="number" tips="请填写所求数量"></div>
                        </div>
                    </div>
                </div>
