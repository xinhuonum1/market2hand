            ...
            <div class="form-wr">
                <div class="form-must-wr">
                    ...
                    <div class="form-item l goods-title">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input id="name" name="name" placeholder="最多18个字" maxlength="18" value="" type="text"
                                       class="required" tips="请填写商品名称"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-item l goods-price">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="buyPrice" name="buyPrice" value="" type="number"
                                       tips="请填写购物价格"></div>
                        </div>
                    </div>
                    <div class="form-item l goods-price">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="price required" id="sellPrice" name="sellPrice" value="" type="number"
                                       tips="请填写出售价格"></div>
                        </div>
                    </div>
                    ...
                    <div class="form-item l">
                        ...
                        <div class="form-value">
                            <div class="form-input-wr">
                                <input class="required" id="needNumber" name="needNumber" value="" type="number"
                                       tips="请填写库存数量"></div>
                        </div>
                    </div>
