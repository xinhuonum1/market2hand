                ...
                <div class="head-img-area">
                    <div class="wrap-img" id="wrap-img" style="position: relative;">
                        ...
                        <div id="" class="moxie-shim moxie-shim-html5"
                            ...
                            <input id="selected-file" onchange="uploadImg()"
        ...
        <div class="top clearfix" id="user-top">
            ...
            <div id="user_photo">
                <#if ylrc_student.headPic??>
                    <img id="origin_ph" onClick="openUploadPanel()" src="/photo/view?filename=${ylrc_student.headPic}"
                         old-src="/photo/view?filename=${ylrc_student.headPic}" alt="大头像">
                <#else>
        ...
        <div id="my_info">
            <div id="account_info">
                ...
                <ul class="infos" id="userid">
                    <li>账号ID</li>
                    <li class="right_info">${ylrc_student.id}</li>
                </ul>
                    ...
                    <#list goodsList as goods>
                        <div class="enshr_each" id="">
                            <div class="enshr_info">
                                <h2><a href="../goods/detail?id=${goods.id}" title="${goods.name}">${goods.name}</a>
                                </h2>
	                        ...
	                        <span id="prostate">
	                        	...
	                        	<#else>
                                    ...
                                    <div style="margin-top: 10px">
                                        ...
                                        <#if goods.status == 1>
                                            <span class="enshrine_it make_edition"
                                                  onclick="offshelf(${goods.id});">下架</span>
                                        <#elseif goods.status == 2>
                                            <span class="enshrine_it make_edition" onclick="onshelf(${goods.id});"
                                                  style="margin-right:30px;">上架</span>
                                        </#if>
                                        <#if goods.flag == 0>
                                            <span class="enshrine_it make_edition"
                                                  onclick="refresh(${goods.id},1);">擦亮</span>
                                        <#else>
                        ...
                        <div class="enshr_each" id="">
                            ...
                            <a href="">
                                <#if wantedGoods.student.headPic??>
                                    <img class="enshr_ph" src="/photo/view?filename=${wantedGoods.student.headPic}"
                                         alt="${wantedGoods.name}">
                                <#else>
                                ...
                                <#if collectorList??>
                                    <#list collectorList as collectors>
                                        <#if collectors.student.id == students.id>
                                            <div class="enshr_each" id="">
                                                <div class="enshr_info">
                                                    <h2><a href="../goods/detail?id=${collectors.id}"
                                                           title="${collectors.name}">${collectors.name}</a></h2>
	                        ...
	                        <span id="prostate">
	                        	...
	                        	<#else>
                                    <font style="color:red;">否</font>
                                                            ...
                                                            &nbsp;&nbsp;<span
                                                                    id="prostate">上架日期：${collectors.updateTime}</span>
                                                        </div>
                                                        <div style="margin-top: 10px">
                                                            <a href="javascript:void(0);"
                                                               onclick="removeCollection(${collectors.id})"
                                                               target="_top">
                                                ...
                                                <a href="../goods/detail?id=${collectors.id}">
                                                    <img class="enshr_ph" src="/photo/view?filename=${collectors.photo}"
                                                         alt="${collectors.name}">
                                                </a>
                                            </div>
                                        </#if>
            ...
            <div id="onsale_pro">
                <#if reportGoodsList??>
                    <#list reportGoodsList as reportGoods>
                        <div class="enshr_each" id="">
                            <div class="enshr_info">
                                <h2><a href="../goods/detail?id=${reportGoods.goods.id}"
                                       title="${reportGoods.goods.name}">${reportGoods.goods.name}</a></h2>
                            ...
                            <a href="../goods/detail?id=${reportGoods.goods.id}">
                                <img class="enshr_ph" src="/photo/view?filename=${reportGoods.goods.photo}"
                                     alt="${reportGoods.goods.name}">
                            </a>
                        </div>
                    </#list>
                </#if>
