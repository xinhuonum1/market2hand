        ...
        <div class="search-box-wr ease2">
            <div class="search-box center">
                ...
                <div class="input-wr">
                    ...
                    <div class="search-input">
                        <input name="keyword" id="keyword" x-webkit-speech="" placeholder="搜索你想要的商品" value="${name!""}"
                               type="text">
                    </div>
                </div>
            </div>
            ...
            <div class="search-hots center ease2">
                ...
                <#list goodsCategorys as hotGoodsCategory>
                    ...
                    <#else>
                        <a class="hots" href="/home/goods/list?cid=${hotGoodsCategory.id}"
                           target="_top">${hotGoodsCategory.name}</a>
                    </#if>
                    ...
                    <div id="person_info" class="clearfix">
                        <a href="../student/index">
                            <#if ylrc_student.headPic??>
                                <img class="avatar" style="height:48px;width:48px;"
                                     src="/photo/view?filename=${ylrc_student.headPic}">
                            <#else>
                                <img class="avatar" style="height:48px;width:48px;" src="/home/imgs/avatar1.png">
                            </#if>
                        </a>
                        <div style="display:inline;" class="person_name">
                            <a href="../student/index" id="id-btn"
                               style="font-size: 16px;">${ylrc_student.nickname!ylrc_student.stuemail}</a>
                        </div>
                        <div style="display:inline;" class="person_name">

                            <a href="../student/news" style="font-size: 16px" id="imessage-btn">消息
                                <#if NewsCount?number gt 0>
                                    <span class="layui-badge">${NewsCount}</span>
                                </#if>
                            </a>
                        </div>
                        <div style="display:inline;" class="person_name">
                            <a href="../index/logout" style="font-size: 16px"
                               id="log-btn">&nbsp;&nbsp;&nbsp;&nbsp;退出</a>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    ...
    $("#imessage-btn").on('click', function () {
